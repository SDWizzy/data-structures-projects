...
\begin{enumerate}
    ...
    \item \textbf{Search hats:} Choose whether to search by ID, color, brand, or coolness level, then enter the requested value. The program displays all exact matches. Text searches use the entered spelling and capitalization.
